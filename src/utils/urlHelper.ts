/**
 * Helper to get the correct path including any GitHub Pages repo base or custom domain
 */
...
/**
 * Safely push state preserving repository base path
 */
...
/**
 * Safely replace state preserving repository base path
 */
